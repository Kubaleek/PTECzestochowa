...
export async function POST(request: NextRequest) {
  ...
  const filePath = path.join(process.cwd(), 'public', 'assets', 'Courses','Certificates', file.name);
  ...
  try {
    ...
    const courseLink = `/assets/Courses/Certificates/${file.name}`; // This line formats the link correctly
