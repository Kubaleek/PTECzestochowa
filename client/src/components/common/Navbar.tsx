          ...
          {isLoading ? (
            <div className="text-white flex justify-center items-center">
              <svg
                aria-hidden="true"
                role="status"
                className="inline w-4 h-4 me-2 text-[#fff] animate-spin"
                viewBox="0 0 100 101"
                fill="none"
                ...
                >
                  <button type="button" className="relative text-white">
                    ...
                    <span
                      style={{
                        transform:
                          openCategory === category ? "scaleX(1)" : "scaleX(0)",
                      }}
                      className="absolute -bottom-2 -left-2 -right-2 h-px origin-left scale-x-0 rounded-full bg-white transition-transform duration-300 ease-out"
                    />
                  </button>
                  <AnimatePresence>
                    {openCategory === category && (
                      <motion.div
                        ...
                        className="absolute top-12 bg-white shadow-lg border border-[#080808]/25 overflow-hidden"
