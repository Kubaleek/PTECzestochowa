    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-4">
                {news.map(((item) => (
                    <a href="" key={item.subpost_id} className="border-2 group border-[#17822e]/50 shadow-lg opacity-70 p-2 rounded-lg hover:opacity-100 lg:hover:bg-[#f9f2eb] lg:hover:border-[#17822e] transition-all duration-300">
