...
const FileBox: React.FC<IProps> = ({ label, name, error, info, onFilesChange }) => {
    ...
    return (
        <>
            ...
            <div {...getRootProps({ className: `flex w-full cursor-pointer appearance-none items-center justify-center rounded-md border-2 border-dashed p-6 transition-all duration-300 ease ${borderClass}` })}>
