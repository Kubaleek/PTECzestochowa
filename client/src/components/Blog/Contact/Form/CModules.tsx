      ...
      <div className="flex flex-col">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
          ...
          <FormControl variant="standard" color="success" fullWidth>
            ...
            <Select
              id="courseTopics"
              {...register("courseTopics", {
                required: "Tematyka Szkoleniowa jest wymagana",
              })}
            >
          ...
          <DynamicFormInput
            ...
            validation={{
              required:
                "Plik z umową na przetwarzanie danych osobowych jest wymagane",
            }}
            error={errors.file}
            name="file"
            control={control}
          ...
          <div className="flex flex-col gap-2">
            <DynamicFormInput
              label="Wyrażam zgodę na przesyłanie mi ofert reklamowych i promocyjnych od PTE"
              register={register}
              validation={{}}
              error={undefined}
              name="consent2"
