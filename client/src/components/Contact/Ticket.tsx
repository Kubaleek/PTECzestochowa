...
export default function Ticket({ label } : {label: string}) {
    ...
    return (
        <>
            ...
            <form className="mt-4 flex flex-col gap-3 xl:gap-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 xl:gap-6">
                    <h3 className="text-[20px] p-2 sm:text-[24px] font-semibold text-white bg-[#17822e] rounded flex justify-center items-center shadow text-center">Pole danych faktury</h3>
