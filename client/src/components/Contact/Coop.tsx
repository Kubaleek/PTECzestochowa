        ...
        <>
            ...
            <form className="flex flex-col gap-2 mt-3">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <CheckBox id="rodo" name="rodo" label="Wyrażam zgodę na wykorzystanie moich danych osobowych w celu kontaktu ze strony PTE Częstochowa" tooltipContent="Należy zaznaczyć, jeśli chcesz przekazać nam wiadomość" />
