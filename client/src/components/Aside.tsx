    ...
    return (
        <aside className="col-span-12 lg:col-span-4 xl:col-span-3">
            <div className="w-full h-fit mb-0 flex flex-col gap-2">
                ...
                <motion.div initial={{ opacity: 0, x: -30, scale: 0.95 }} animate={{ opacity: 1, x: 0, scale: 1 }} transition={{duration: 0.6,ease: "easeOut",bounce: 0.3,delay: 0.2}}className='flex flex-col gap-3 p-3 px-4 relative rounded-lg border border-[#17842f] bg-white shadow-lg'>
                    {children}
                </motion.div>
            </div>
        </aside>
